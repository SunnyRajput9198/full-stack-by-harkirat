...
//  @ts-ignore
 ...
 useEffect(() => {
   // Create new WebSocket connection to local server isko try kro useeffect ke nadar use kro
   const ws = new WebSocket("ws://localhost:8080");
   
   // Handle incoming messages from server
   ws.onmessage = (event) => {
    // is syntax ka mtlb hain ...m sare purane msg dekh rhi hai while event.data new msg le rha hai
