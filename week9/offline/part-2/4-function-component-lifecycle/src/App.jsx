...
// React lifecycle events are methods that run during a component's three phases: Mounting, Updating, and Unmounting.
//  Key methods include constructor(), render(), and componentDidMount() for setup, and componentWillUnmount() for cleanup.
