...
const defaultStyles = "px-4 py-2 rounded-md font-light flex items-center";      //items-center is for vertically allignment of the item to be center//justify-center is for horizontally allignment of the item to be center
