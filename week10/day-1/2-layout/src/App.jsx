        ...
        <div>
            ...
            <BrowserRouter>
                <Routes>
                    ...
                    {/* if yha pe /neet krde to hme baki sb routes me bhi /neet include krna pdeaga nii to error dega vo it act as base route taki koi random path pe na jae hm log */}
    ...
    return (
        <div >
          {/* basically header */}
            ...
            {/* if hmko child route ko render krna hai to outlet use krte hai */}
            <div >
                <Outlet />
            </div>
            
            {/* Footer section with basic information */}
            <footer style={{ background: "pink" }}>Footer | Contact Us</footer>
        </div>
    );
}
