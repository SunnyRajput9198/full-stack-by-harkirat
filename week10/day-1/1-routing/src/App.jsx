...
{/* in react we use link to for giving link to the page */}
        {/* If we use this link outside this block it will throw an error */}
        {/* ye toh page ko link ko use krenge na toh page har click pe dubara reload hoga ..so isko avoid krne k liye we will use LINK */}
        ...
        <Routes>
          ...
          {/* yeh routes se bta rha hai ki kaunse routes pe kaunsa compoenent render ho rh hai  */}
          <Route path="/neet/online-coahing-class-12" element={<Class12Program/>} />
          <Route path="/" element={<Landing/>} />
          {/* koi bhi unknown path hoga tb ye paage render hoga */}
