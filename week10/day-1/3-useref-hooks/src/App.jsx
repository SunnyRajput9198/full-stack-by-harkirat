...
///isme hmko ye bnana hai ki jb bhi hm submit pe click kre to pointer inputbox pr aa jae focus krne kia
...
function FocusInput() {
  ...
  function focusOnInput() {
      ...
      // created a refernece to the dom element that is what exactly useRef hook does
